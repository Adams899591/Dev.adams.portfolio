 <div data-aos="fade-up"   data-aos-duration="5000" class="group relative bg-slate-900/50 border border-slate-800 hover:border-neon-green/50 rounded-lg overflow-hidden transition-all duration-300 hover:-translate-y-2 glow-box">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-slate-400 text-sm mb-4 line-clamp-2 max-sm:text-[10px]"> A simple student portal built with HTML CSS and javascript.</p>
                        ...
                        <div class="flex items-center gap-6">
                            <a href="https://github.com/Adams899591/FUDMA-portal" class="inline-flex items-center text-sm text-sm max-sm:text-[10px] text-slate-400 hover:text-white transition-colors">
                                View Code <span class="ml-2 text-slate-600">&rarr;</span>
                            </a>
                            <a href="https://adams899591.github.io/FUDMA-portal/" class="inline-flex items-center text-sm text-sm max-sm:text-[10px] text-neon-green hover:text-white transition-colors">
